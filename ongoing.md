...
Goals:
1. Get a csv loaded [x]
2. Have an LLM navigate the CSV in the environment and generate Q&A pairs for classification or regression. [x]
3. Have an LLM solve Q&A pairs. [x]
